...
export default function Footer() {
  return (
    <footer className="px-6 divide-y dark:bg-purple-50 dark:text-gray-800 mt-6 md:mt-10">
      <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
        ...
        <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
          <div className="space-y-3">
            <h3 className="tracking-wide uppercase font-bold dark:text-gray-900">Product</h3>
          ...
          <div className="space-y-3">
            <h3 className="tracking-wide font-bold uppercase dark:text-gray-900">Company</h3>
            <ul className="space-y-1">
              <li>
