...
const getStatusIcon = (status: string): React.ReactNode => {
  switch (status) {
    case "approved":
      return <CheckIcon className="size-3 mr-1" />;
    case "pending":
      return <ClockIcon className="size-3 mr-1" />;
    case "complete":
      return <CheckCircleIcon className="size-3 mr-1" />;
    case "incomplete":
      return <XMarkIcon className="size-3 mr-1" />;
    default:
      return null;
  }
};
